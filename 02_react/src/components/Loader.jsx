...
import '../components/style/loaderStyle.css'; // Add the corresponding styles for loader
	...
	<g transform="translate(28,28)">
		...
		<g fill="none" stroke-linecap="round" stroke-width="2.5" transform="rotate(-90)">
			<g className="pl__stripe-rotate">
				<circle className="pl__stripe pl__stripe--1" r="18.25" stroke="var(--red)" stroke-dasharray="114.7 114.7" />
			</g>
			<g className="pl__stripe-rotate">
				<circle className="pl__stripe pl__stripe--2" r="15.75" stroke="var(--white)" stroke-dasharray="106.8 106.8" />
			</g>
			<g className="pl__stripe-rotate">
				<circle className="pl__stripe pl__stripe--3" r="13.25" stroke="var(--blue)" stroke-dasharray="99 99" />
			</g>
		</g>
		<g className="pl__ball" transform="translate(0,-15.75)">
			<circle className="pl__ball-shadow" filter="url(#ball-shadow-outside)" fill="hsla(var(--hue),10%,10%,0.5)" r="8" cx="1" cy="1" />
			<circle fill="var(--white)" r="8" />
			<g clip-path="url(#ball-clip)">
				<use className="pl__ball-texture" href="#ball-texture" />
			</g>
			<circle className="pl__ball-shadow" clip-path="url(#ball-clip)" filter="url(#ball-shadow-inside)" fill="none" stroke="hsla(var(--hue),10%,10%,0.3)" stroke-width="5" r="12" cx="-4" cy="-4" />
		</g>
	</g>
</svg>
  </div>
